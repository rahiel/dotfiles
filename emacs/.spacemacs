...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(paredit comment-dwim-2 crux intero sage-shell-mode
                                              xah-math-input nginx-mode writegood-mode)
...
you should place your code here."
  ...
  (global-set-key (kbd "<f9>") 'spacemacs/deft)
